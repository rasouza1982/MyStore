...
namespace MyStore.Infra.Persistence.Mappings
{
    public class UserMapping : EntityTypeConfiguration<User>
    {
        public UserMapping()
        {
            ...
            Property(x => x.Role);
            Property(x => x.ActivationCode).HasMaxLength(4).IsFixedLength();
            Property(x => x.VerificationCode).HasMaxLength(6).IsFixedLength();
            Property(x => x.AuthorizationCode).HasMaxLength(4).IsFixedLength();
